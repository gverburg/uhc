...
EHC_HS_UTIL_SRC_CHS						:= $(patsubst %,$(SRC_EHC_PREFIX)%.chs,\
													FinalEnv Substitutable Opts Gam VarMp VarLookup Deriving Generics Module Config BuiltinPrims NameAspect DerivationTree CHR Pred HI LamInfo AbstractCore StrictnessDomain\
...
$(LIB_EHC_CABAL_DRV): $(EHC_ALL_DPDS_NO_MAIN) $(EHC_MKF)
	...
	$(call FUN_GEN_CABAL_LIB \
		, $(LIB_EHC_PKG_NAME) \
		, $(EH_VERSION_SHORT) \
		, $(LIB_EH_UTIL_PKG_NAME) binary syb bytestring uulib>=0.9.12 old-locale \
